...
{
    public class iPlanningCorsi : Base001
    {
        protected iPlanningCorsiClient planningCorsiClient = new iPlanningCorsiClient();
        ...
        public async Task RecuperiConta()
        {
            ...
            var esito = await planningCorsiClient.RecuperiContaAsync(baseRequest,
        ...
        public async Task RecuperiGetItems()
        {
            ...
            var esito = await planningCorsiClient.RecuperiGetItemsAsync(baseRequest,
        ...
        public async Task RecuperiInsert()
        {
            ...
            var esito = await planningCorsiClient.RecuperiInsertAsync(baseRequest,
                new dcReservation()
                {
